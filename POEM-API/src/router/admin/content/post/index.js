...
const { createPost,updatePost, postList,postSelectList, postItem, delPost, upDatePostRecycle, updateCheckPost } = require('../../../../controller/admin/content/post')
...
router.get('/content/postSelectList', postSelectList)
